...
- Jim Carrey: Born January 17, 1962 in Newmarket. Comedian and actor known for energetic style.
    ...
    },
    {
      ...
      images: [
        ...
        "https://www.shutterstock.com/shutterstock/photos/278364995/display_1500/stock-vector-canada-political-map-with-capital-ottawa-national-borders-important-cities-rivers-and-lakes-278364995.jpg"
      ],
    },
    {
  ...
  const placesData = [
    {
      ...
      description:
        "A natural wonder with one of the most famous waterfalls in the world, located on the border between Canada & the United States.",
      images: [
    ...
    },
    {
      ...
      description:
        "Banff National Park, in Alberta, is the first national park of Canada and part of the Rocky Mountains. Lake Louise: Is a famous glacier-fed lake located in Banff National Park, Alberta. It has turquoise-colored waters surrounded by high mountains.",
    ...
    },
    {
      ...
      description: "Famous for having the highest tides in the world, located between New Brunswick and Nova Scotia.",
      images: [
    ...
    },
    {
      ...
      description:
        "It is the largest city in Canada and the capital of Ontario. It is a multicultural city.",
      images: [
    ...
    {
      title: "Ottawa",
      img: "https://images.gostudy.com.au/w:1258/h:833/q:mauto/f:best/https://www.gostudycanada.com/wp-content/uploads/2021/02/iStock-472209533.jpg",
      description:
        "Canada’s capital city, with historic landmarks like Parliament Hill.",
      images: [
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSk2lvoAvrl6CHMb0x6WuEB_DmzGLOR7KSiTQ&s",
        "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0e/cf/57/e4/rideau-canal-skateway.jpg?w=600&h=-1&s=1",
        "https://guias-viajar.com/wp-content/uploads/2014/07/Fotos-Canada-Ottawa-002-2.jpg",
      ],
    },
  ];
